  ...
  ({
    ...
    const renderLogoItem = useCallback(
      (item: LogoItem, key: React.Key) => {
        ...
        const name = isNodeItem ? item.title : item.alt ?? item.title;

        const content = (
          <div // Pill background wrapper
            className={cx(
              'flex items-center gap-x-2.5 px-4 py-2 rounded-full',
          ...
          >
            ...
            {name && (
              <span className="font-medium text-sm text-gray-600 dark:text-gray-300 whitespace-nowrap">
                {name}
              </span>
            )}
          </div>
